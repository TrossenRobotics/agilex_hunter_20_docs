...
project = 'AgileX HUNTER 2.0 Documentation'
...
html_title = "AgileX HUNTER 2.0 Documentation"
...
html_logo = "_images/logo_hunter_20.png"
...
html_context = {
    ...
    'github_repo': 'agilex_hunter_20_docs', # Repo name
...
htmlhelp_basename = 'AgileXHUNTER2Documentation'
